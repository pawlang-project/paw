...
**状态**: 已识别，待修复  
**影响**: 元组无法作为函数参数按值传递  
**测试**: `examples/tuple_test.paw` (已跳过)
...
**原因**: 与Struct按值传递类似，元组（LLVM StructType）需要特殊处理
...
**PawLang v0.2.2** 核心功能稳定，所有27个测试用例100%通过。
...
### 待修复问题:
- ⚠️ 元组按值传递 (计划v0.2.3)
- ⚠️ Struct按值传递 (计划v0.2.3)

### 推荐操作:
1. ✅ 可以发布 v0.2.2
2. 创建 v0.2.3 分支修复已知问题
3. 继续完善标准库和文档
