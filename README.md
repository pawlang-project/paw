...
paw/
├── src/
│   ├── main.cpp              # Compiler entry point (with LLVM downloader)
...
│   │   ├── parser.h
│   │   └── parser.cpp
│   ├── codegen/              # LLVM code generation (6 files)
│   │   ├── codegen.h
...
│   ├── error_reporter.cpp    # Error reporting system
│   ├── colors.cpp            # Color output
│   └── toml_parser.cpp       # TOML config parser
├── stdlib/std/               # Standard library (15 modules)
│   ├── array.paw
│   ├── collections.paw
│   ├── conv.paw
│   ├── fmt.paw
